...
<div class="pageContent">
	<form id="nodeForm"  method="post" action="flow.do?method=${method}" class="pageForm required-validate" 
			...
			<div id="u_div" style="overflow:hidden; width:380px; height:100px;">
			    <p>
					...
					<span style="line-height: 20px;margin-left:5px;margin-top:5px;">
    					<a target="dialog" width="850" height="550" mask="true" rel="udialog" href="flow.do?method=userDialog&id=${node.nodeId}" title="用户列表"><img src="${basePath}appadmin/images/persons.gif"></img></a>
					</span>
				</p>
				<p>
					<label>接收组织：</label>
					...
					<span style="line-height: 20px;margin-left:5px;margin-top:5px;">
					<a target="dialog" width="400" height="550" mask="true" rel="udialog" href="appadmin/flow/orgDialog.jsp" title="添加组织"><img src="${basePath}appadmin/images/persons.gif"></img></a>
					</span>
				</p>
			<!--   
			<p>
...
<script type="text/javascript">
	...
	function subNodeForm(oldName) {
		var _nodeName = $('#fnodeName').val();
			...
			var _url = "flow.do?method=checkNode";
			var _data = {
				flowId : '${flowId}',
				nodeName : _nodeName
			}
