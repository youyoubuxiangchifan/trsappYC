...
<div class="pageContent">
	<form name="formUser" method="post" action="${basePath}group.do?method=creatGroupUser" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone)">
		<input type="hidden" name="groupIds" value="${groupIds}"/>
		<div class="pageFormContent" layoutH="56">
			<div class="unit">
				<label>用户名：</label>
				<INPUT type="text" name="userName" id="userName" value="" class="required" minlength="3" maxlength="20"  />
			</div>
			<div class="unit">
				<label>密码：</label>
				<INPUT id="w_validation_pwd" type="password" name="userPwd" value=""  minlength="8" maxlength="30" class="required" onKeyUp="pwStrength(this.value)"/>
			</div>
			<div class="unit">
				<label></label>
			...
			<div class="unit">
				<label>确认密码：</label>
				<INPUT type="password"  name="sureUserPwd" value="" class="required" equalto="#w_validation_pwd" />
			</div>		
			<div class="unit">
				<label>真实姓名：</label>
				<INPUT type="text"  name="trueName" value="" class="required" />
			</div>
			<div class="unit">
				<label>联系电话：</label>
				<INPUT type="text"  name="moblie" value="" class="phone"  />
			</div>			
			<div class="unit">
				<label>电子邮件：</label>
