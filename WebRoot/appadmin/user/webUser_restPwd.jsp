...
<div class="pageContent">
	<form method="post" action="${basePath}appMgr.do?method=upPassword" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone)">
		...
		<div class="pageFormContent" layoutH="56">
			...
			<div class="unit">
				<label>原密码：</label>
				<INPUT type="password" name=currPwd value="" class="required" minlength="8" maxlength="30"  style="width:160px;"/>
			</div>			
			<div class="unit">
				<label>新密码：</label>
